...
typedef int f_plainf(int,float,float*,float,float,float,float,float*,ABOOL*);
typedef int f_plain(int,double,double*,double,double,double,double,double*,ABOOL*);
typedef int f_plainl(int,long double,long double*,long double,long double,long double,long double,long double*,ABOOL*);
typedef int f_referencef(int,float,float,float,mpfr_t,mpfr_t,float*,ABOOL*);
typedef int f_reference(int,double,double,double,mpfr_t,mpfr_t,double*,ABOOL*);
typedef int f_referencel(int,long double,long double,long double,mpfr_t,mpfr_t,long double*,ABOOL*);
typedef int f_perturbationf(int,int,float,float*,float,float,float,float,float*,float*,ABOOL*);
typedef int f_perturbation(int,int,double,double*,double,double,double,double,double*,double*,ABOOL*);
typedef int f_perturbationl(int,int,long double,long double*,long double,long double,long double,long double,long double*,long double*,ABOOL*);
typedef int f_period_tri(int,double,double,double,mpfr_t,mpfr_t,mpfr_t,ABOOL*,int*);
typedef int f_period_jsk(int,double,double,double,mpfr_t,mpfr_t,mpfr_t,double*,ABOOL*,int*);
typedef int f_newton(int,int,double,double,mpfr_t,mpfr_t,mpfr_t,ABOOL*,int*);
typedef int f_size(int,double,double,mpfr_t,mpfr_t,mpfr_t,double*,ABOOL*,int*);
typedef int f_skew(int,double,double,mpfr_t,mpfr_t,int,double*,ABOOL*,int*);
typedef int f_domain_size(int,double,double,mpfr_t,mpfr_t,mpfr_t,ABOOL*);
