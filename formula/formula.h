...
bool perturbation2_scaled_double (const int m_nFractalType, const int m_nPower, const double      *m_db_dxr, const double      *m_db_dxi, const double *m_db_z, int2  &antal, double2  &test1, double2  &test2, int2  &bGlitch, const double m_nBailout2, const int nMaxIter, const int m_bNoGlitchDetection, const double g_real, const double g_imag, const double g_FactorAR, const double g_FactorAI, double2       &xr, double2       &xi, const double2       &cr, const double2       &ci, const int &chunksize, const double s, const double S);
bool perturbation4_scaled_double (const int m_nFractalType, const int m_nPower, const double      *m_db_dxr, const double      *m_db_dxi, const double *m_db_z, int4  &antal, double4  &test1, double4  &test2, int4  &bGlitch, const double m_nBailout2, const int nMaxIter, const int m_bNoGlitchDetection, const double g_real, const double g_imag, const double g_FactorAR, const double g_FactorAI, double4       &xr, double4       &xi, const double4       &cr, const double4       &ci, const int &chunksize, const double s, const double S);
bool perturbation8_scaled_double (const int m_nFractalType, const int m_nPower, const double      *m_db_dxr, const double      *m_db_dxi, const double *m_db_z, int8  &antal, double8  &test1, double8  &test2, int8  &bGlitch, const double m_nBailout2, const int nMaxIter, const int m_bNoGlitchDetection, const double g_real, const double g_imag, const double g_FactorAR, const double g_FactorAI, double8       &xr, double8       &xi, const double8       &cr, const double8       &ci, const int &chunksize, const double s, const double S);
bool perturbation16_scaled_double(const int m_nFractalType, const int m_nPower, const double      *m_db_dxr, const double      *m_db_dxi, const double *m_db_z, int16 &antal, double16 &test1, double16 &test2, int16 &bGlitch, const double m_nBailout2, const int nMaxIter, const int m_bNoGlitchDetection, const double g_real, const double g_imag, const double g_FactorAR, const double g_FactorAI, double16      &xr, double16      &xi, const double16      &cr, const double16      &ci, const int &chunksize, const double s, const double S);
