...
// "Perturbation and Approximation Tuning" dialog
#define IDD_PTSATUNING                  123
#define IDC_PTSATUNING_GLITCHTOLERANCE  1231
#define IDC_PTSATUNING_MAXREFERENCES    1232
