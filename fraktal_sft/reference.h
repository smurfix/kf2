...
struct Reference;
struct Reference *reference_new(const int64_t capacity, const bool strict_zero, const enum Reference_Type reftype, bool convergent);
...
void reference_append(struct Reference *R, const floatexp &X, const floatexp &Y, const floatexp &Z, const floatexp &Wx, const floatexp &Wy);
