...
void CFraktalSFT::CalculateReferenceLDBL()
{
	...
	{
		bool ok = reference(GetHybridFormula(), m_ldxr, m_ldxi, m_db_z, m_bStop, m_nRDone, m_nGlitchIter, m_nMaxIter, m_rref, m_iref, g_SeedR, g_SeedI, terminate, GetGlitchLowTolerance());
