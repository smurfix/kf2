		...
		if (m_nFractalType == 1 && m_nPower == 2){
			...
			if (antal<nMaxIter && test1 <= m_nBailout2){
				for (; antal<nMaxIter && test1 <= m_nBailout2; antal++){
					...
					floatexp ab = r + a;
					Dnr = (r*r - _3*i*i) * Dnr + (_2*a*r + a2 - _6*i*b - _3*b2)*ab.abs() + a0;
					...
					ab = i + b;
					Dni = (_3*r*r - i*i) * Dni + (_6*r*a + _3*a2 - _2*i*b - b2) * ab.abs() + b0;
			...
			//4th power burning ship
				...
				if (antal<nMaxIter && test1 <= m_nBailout2){
					for (; antal<nMaxIter && test1 <= m_nBailout2; antal++){
						...
						floatexp sr = r*r;
						floatexp si = i*i;
						Dnr = _4*r*r*r*Dr + _6*r*r*Dr*Dr + _4*r*Dr*Dr*Dr + Dr*Dr*Dr*Dr + _4*i*i*i*Di + _6*i*i*Di*Di + _4*i*Di*Di*Di + Di*Di*Di*Di - _12*r*r*i*Di-_6*r*r*Di*Di-_12*r*Dr*i*i-_24*r*Dr*i*Di-_12*r*Dr*Di*Di-_6*Dr*Dr*i*i-_12*Dr*Dr*i*Di-_6*Dr*Dr*Di*Di + dbD0r;

						floatexp c = r*i;
						floatexp d = r*Di + Dr*i + Dr*Di;
						if (c>0){
							if (c + d>0)
								Dni = d;
							else if (d == -c)
						...
						Dni = _4*(sr-si)*(Dni) + _4*_abs(r*i + r*Di + Dr*i + Dr*Di)*(_2*Dr*r+Dr*Dr-_2*Di*i-Di*Di) + dbD0i;
			...
			//5th power burning ship
				...
				if (antal<nMaxIter && test1 <= m_nBailout2){
					for (; antal<nMaxIter && test1 <= m_nBailout2; antal++){
						...
						Dnr = (Dnr) * (r*r*r*r- _10*r*r*i*i + _5*i*i*i*i) + _abs(r+Dr) * (_4*r*r*r*Dr+_6*r*r*Dr*Dr+_4*r*Dr*Dr*Dr+Dr*Dr*Dr*Dr -_20*r*r*i*Di-_10*r*r*Di*Di-_20*r*Dr*i*i-_40*r*Dr*i*Di-_20*r*Dr*Di*Di-_10*Dr*Dr*i*i-_20*Dr*Dr*i*Di-_10*Dr*Dr*Di*Di + _20*i*i*i*Di+_30*i*i*Di*Di+_20*i*Di*Di*Di+_5*Di*Di*Di*Di) + dbD0r;
						...
						Dni = (Dni) * (_5*r*r*r*r - _10*r*r*i*i + i*i*i*i) + _abs(i+Di)*(_20*r*r*r*Dr+_30*r*r*Dr*Dr+_20*r*Dr*Dr*Dr+_5*Dr*Dr*Dr*Dr - _20*r*r*i*Di-_10*r*r*Di*Di-_20*r*Dr*i*i-_40*r*Dr*i*Di-_20*r*Dr*Di*Di-_10*Dr*Dr*i*i-_20*Dr*Dr*i*Di-_10*Dr*Dr*Di*Di +_4*i*i*i*Di+_6*i*i*Di*Di+_4*i*Di*Di*Di+Di*Di*Di*Di) + dbD0i;
