...
//
  ...
  // Where do we calculate it? (Parameters etc)
	...
	// Settings store the target image size and a supersampling factor
	...
	float **m_nTrans;  // smoothed part of iteration count
...
// TODO sort all of the below
	...
	void UpdateBitmap();
#endif
	int GetWidth();  // rteurns m_nX / m_nY
	int GetHeight();
