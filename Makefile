...
formula/perturbation_simple.cpp: formula/formula.xml formula/perturbation_simple1.cpp.xsl preprocessor
	( echo "/* this file is autogenerated, do not edit directly */" ; $(XSLTPROC) formula/perturbation_simple.cpp.xsl $< | ./preprocessor ) > $@

formula/perturbation_simple_derivatives.cpp: formula/formula.xml formula/perturbation_simple_derivatives1.cpp.xsl preprocessor
...
formula/perturbation_simd.cpp: formula/formula.xml formula/perturbation_simd1.cpp.xsl preprocessor
	( echo "/* this file is autogenerated, do not edit directly */" ; $(XSLTPROC) formula/perturbation_simd.cpp.xsl $< | ./preprocessor ) > $@

formula/perturbation_simd_derivatives.cpp: formula/formula.xml formula/perturbation_simd_derivatives1.cpp.xsl preprocessor
	( echo "/* this file is autogenerated, do not edit directly */" ; $(XSLTPROC) formula/perturbation_simd_derivatives.cpp.xsl $< | ./preprocessor ) > $@

formula/perturbation_scaled.cpp: formula/formula.xml formula/perturbation_scaled1.cpp.xsl preprocessor
	( echo "/* this file is autogenerated, do not edit directly */" ; $(XSLTPROC) formula/perturbation_scaled.cpp.xsl $< | ./preprocessor ) > $@

formula/perturbation_scaled_derivatives.cpp: formula/formula.xml formula/perturbation_scaled_derivatives1.cpp.xsl preprocessor
...
formula/miscellaneous.cpp: formula/formula.xml formula/miscellaneous.cpp.xsl preprocessor
	( echo "/* this file is autogenerated, do not edit directly */" ; $(XSLTPROC) formula/miscellaneous.cpp.xsl $< | ./preprocessor ) > $@
