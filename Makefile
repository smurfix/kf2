...
OBJECTS_CPP := $(patsubst %.cpp,%.o,$(SOURCES_CPP)) formula/formula.1.o formula/formula.2.o formula/formula.3.o formula/formula.4.o formula/formula.5.o formula/formula.6.o formula/formula.7.o formula/formula.8.o formula/formula.9.o formula/formula.A.o formula/formula.B.o
...
%.B.o: %.cpp
	$(COMPILE) $(COMPILE_FLAGS) -DPASSB -o $@ -c $<
