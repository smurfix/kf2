...
set title "Built-in"
set xlabel "formula"
plot [-1:293][:] "cpu/builtin.dat" u (3 * floor($0/2) + 2 + $3):($4) w i t "CPU", "cl1/builtin.dat" u (3 * floor($0/2) + 2 + $3 + 0.5):($4-$11) w i t "GPU"
set output "hybrid.png"
set title "Hybrid"
set xlabel "formula"
plot [-1:164][:] "cpu/hybrid.dat" u (3 * floor($0/2) + 2 + $3):($4) w i t "CPU", "cl1/hybrid.dat" u (3 * floor($0/2) + 2 + $3 + 0.5):($4-$11) w i t "GPU"
