...
set title "Built-in"
set xlabel "formula"
plot [-1:130][:] "cpu/builtin.dat" u ($0 + floor($0/2) + 1):($4) w i t "CPU", "cl1/builtin.dat" u ($0 + floor($0/2) + 2 + 1 + 0.5):($4-$11) w i t "GPU"
set output "hybrid.png"
set title "Hybrid"
set xlabel "formula"
plot [-1:272][:] "cpu/hybrid.dat" u ($0 + floor($0/4) + 1):($4) w i t "CPU", "cl1/hybrid.dat" u ($0 + floor($0/4) + 2 + 1 + 0.5):($4-$11) w i t "GPU"
